...
export class MvHeaderDemo extends LitElement {
  ...
  render() {
    const light =
        "--mv-header-background: #F3F3F3;" +
        "--mv-header-item-color: #80828C;";
    return html`
    <mv-header style="${this.open ? light : ""}">
    ...
    <div class="content">
      ...
      <contained-header-demo style="${this.open ? light : ""}"></contained-header-demo>     
